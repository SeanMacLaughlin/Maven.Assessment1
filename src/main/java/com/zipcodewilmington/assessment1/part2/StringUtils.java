...
public class StringUtils {
    ...
    public static String reverseFirstWord(String sentence) {
        ...
        newBuild.append(first);
        newBuild = newBuild.reverse();
        String rev = newBuild.toString();
        return rev;
    }
    ...
    public static String reverseFirstWordThenCamelCase(String sentence) {
        ...
        newBuild = newBuild.reverse();
        String rev = newBuild.toString();
        String ayeAyeCap = rev.substring(0, 1).toUpperCase() + rev.substring(1);
        return ayeAyeCap;
    }
    ...
    public static String removeCharacterAtIndex(String str, int index) {
        StringBuilder newNew = new StringBuilder();
        newNew.append(str);
        newNew = newNew.deleteCharAt(index);
        String outchea = newNew.toString();
        return outchea;
    }
